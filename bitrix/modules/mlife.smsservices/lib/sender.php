	...
	*/
	...
	public function getAllSender($main=true) {
		...
		if($main===true){
			...
			if($this->transport_app!==null){
				$cache_time = \Bitrix\Main\Config\Option::get("mlife.smsservices","cacheotp_app","86400","");
	...
	public function getAllSenderOptions($main=true) {
		...
		/*if((\Bitrix\Main\Config\Option::get("mlife.smsservices", "listotp","","")!='Y') && $main===true){
			return '';
		}elseif((\Bitrix\Main\Config\Option::get("mlife.smsservices", "listotp_r","","")!='Y') && $main===false) {
			return '';
		}elseif((\Bitrix\Main\Config\Option::get("mlife.smsservices", "listotp_app","","")!='Y') && $main=='app') {
			return '';
		}*/
