...
метод для отправки смс, в случае успеха возвращает объект: ('id','cnt','cost','balance'), в случае ошибки: ('error','error_code')
...
параметры cnt,cost,balance - возвращаются не всеми сервисами! В случае, если сервис после отправки сообщения не передает данные параметры они будут пустые!
